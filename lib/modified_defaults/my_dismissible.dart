...
class MyDismissible extends StatefulWidget {
  ...
  /// MyDismissible will begin upon the detection of a drag gesture. If set to
...
class _MyDismissibleState extends State<MyDismissible> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (_resizeAnimation != null) {
      ...
      // TODO (quevigil): This is against what I'm trying to achieve!
      // assert(() {
      //   if (_resizeAnimation.status != AnimationStatus.forward) {
      //     assert(_resizeAnimation.status == AnimationStatus.completed);
      //     throw FlutterError.fromParts(<DiagnosticsNode>[
      //       ErrorSummary('A dismissed MyDismissible widget is still part of the tree.'),
      //       ErrorHint(
