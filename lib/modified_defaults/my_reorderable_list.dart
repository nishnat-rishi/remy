...
class MyReorderableListView extends StatefulWidget {
  ...
  /// ScrollPhysics for [MyReorderableListView].
  ...
  /// Called after a list child starts being dragged.
  final void Function() onDragStart;

  /// Called after a list child is dropped.
...
class _MyReorderableListViewState extends State<MyReorderableListView> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$MyReorderableListView overlay key');
...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  // TODO (quevigil): Severely messes up drag mechanics.
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    void onDragEnded() {
      ...
      // TODO (quevigil): This hack is only designed for NeverScrollableScrollPhysics()
      // TODO (quevigil): Overshooting scroll position solved here!
      // setState(() {
